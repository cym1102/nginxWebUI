...
```
Linux: wget -O /home/nginxWebUI/nginxWebUI.jar http://file.nginxwebui.cn/nginxWebUI-3.3.8.jar

Windows: Download directly from your browser http://file.nginxwebui.cn/nginxWebUI-3.3.8.jar
```
