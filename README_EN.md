...
```
docker pull cym1102/nginxwebui:2.5.2
```

3.start container

```
docker run -itd -v /home/nginxWebUI:/home/nginxWebUI -e BOOT_OPTIONS="--server.port=8080" --privileged=true --net=host  cym1102/nginxwebui:2.5.2 /bin/bash
```
