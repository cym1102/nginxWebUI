...
```
Linux: wget -O /home/nginxWebUI/nginxWebUI.jar http://file.nginxwebui.cn/nginxWebUI-2.8.4.jar

Windows: Download directly from your browser http://file.nginxwebui.cn/nginxWebUI-2.8.4.jar
```
