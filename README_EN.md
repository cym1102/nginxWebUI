...
```
Demo address: http://154.31.21.178:8080 
User: admin
password: Admin123
```
...
```
wget -O /home/nginxWebUI/nginxWebUI.jar http://file.nginxwebui.cn/nginxWebUI-2.7.0.jar
```
...
```
docker pull cym1102/nginxwebui:2.7.0
```

3.start container

```
docker run -itd -v /home/nginxWebUI:/home/nginxWebUI -e BOOT_OPTIONS="--server.port=8080" --privileged=true --net=host  cym1102/nginxwebui:2.7.0 /bin/bash
```
...
services:
  nginxWebUi-server:
    image: cym1102/nginxwebui:2.7.0
    volumes:
      - type: bind
...
```
docker build -t nginxwebui:2.7.0 .
```
