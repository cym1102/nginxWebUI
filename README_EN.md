...
```
docker pull cym1102/nginxwebui:2.5.4
```

3.start container

```
docker run -itd -v /home/nginxWebUI:/home/nginxWebUI -e BOOT_OPTIONS="--server.port=8080" --privileged=true --net=host  cym1102/nginxwebui:2.5.4 /bin/bash
```
...
```
docker build -t nginxwebui:2.5.4 .
```
