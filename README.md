...
```
wget http://www.nginxwebui.cn/download/nginxWebUI-1.5.9.jar
```
...
```
nohup java -jar -Xmx64m nginxWebUI-1.5.9.jar --server.port=8080 --project.home=/home/nginxWebUI/ > /del/null &
```
...
```
docker pull registry.cn-hangzhou.aliyuncs.com/cym1102/nginxwebui:1.5.9
```

3. 启动容器: 

```
docker run -itd -v /home/nginxWebUI:/home/nginxWebUI -e BOOT_OPTIONS="--变量名=变量值 --变量名2=变量值2" --privileged=true --net=host  registry.cn-hangzhou.aliyuncs.com/cym1102/nginxwebui:1.5.9 /bin/bash
```
