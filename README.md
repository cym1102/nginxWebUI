...
```
nohup java -jar -Xmx64m nginxWebUI-1.2.5.jar --server.port=8080 --logging.file.path=/home/log/nginxWebUI.log --spring.database.sqlite-path=/home/nginxWebUI/sqlite &
```
